        ...
        <div class="row">
            <div class="col-md-2" style="margin:0px 0px 0px 0px ;  ">    
                <div class="sidenav">
                    ...
                    <a class="btn btn-outline-light" href="#">View exam medicals sent to faculty board</a>
...
<script src="https://www.gstatic.com/firebasejs/7.21.0/firebase-firestore.js"></script>
            ...
            if (element.data().status === "faculty board"  && element.data().approved === false && element.data().rejected === false) {
...
<br><button type="button" class="btn btn-primary" onclick="send()">submit</button>
</body>  
</html>