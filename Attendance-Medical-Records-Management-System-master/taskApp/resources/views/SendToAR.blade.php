...
<script src="https://www.gstatic.com/firebasejs/7.21.0/firebase-firestore.js"></script>
            ...
            if (element.data().status === "MA"  && element.data().approved === false && element.data().rejected === false) {
...
<br><button type="button" class="btn btn-primary" onclick="AR()">Send to AR</button>
</body>  
</html>