    ...
    <body bgcolor="#4CAF50">
        ...
        <div class="row">
            <div class="col-md-2" style="margin:0px 0px 0px 0px ;  ">    
                <div class="sidenav">
                <a class="btn btn-outline-light" href="/ARview" style="border-bottom:6px solid #000" >Send To UMO</a>
                    <a class="btn btn-outline-light" href="/AR" style="border-bottom:6px solid #000">View medicals </a>
                    <a class="btn btn-outline-light" href="/ARexam">View exam medicals sent to faculty board </a>
                    <a class="btn btn-outline-light" href="#">View Medical Reports</a>
                </div>
      ...
      <div class="table-responsive">
          ...
          <table class="table"  style="background-color: #167F92 ;   margin:0px 80px 0px 0px;">
            ...
            <thead>
                ...
                <th scope="col" style="text-align: center">Absent for</th>
...
<script src="https://www.gstatic.com/firebasejs/7.21.0/firebase-firestore.js"></script>
            ...
            if (element.data().exam === true && element.data().approved === true) {
                ...
                tb_div2.innerHTML += "<tr><th>"+ element.id  +"</th><td>"+ element.data().name  +"</td><td>"+ element.data().DoS +"</td><td>"+"exam"+"</td><td>"+ element.data().status +"</td><td>"+"approved"
                +"</td><td>"+ "</td></tr>"  
                   
            }else if (element.data().exam === true && element.data().rejected === true) {
               
                    
               tb_div2.innerHTML += "<tr><th>"+ element.id  +"</th><td>"+ element.data().name  +"</td><td>"+ element.data().DoS +"</td><td>"+"exam"+"</td><td>"+ element.data().status +"</td><td> "+"rejected"
               +"</td><td>"+ "</td></tr>"  
                  
           }else if (element.data().exam === true && element.data().rejected === false && element.data().approved === false ) {
               
                    
               tb_div2.innerHTML += "<tr><th>"+ element.id  +"</th><td>"+ element.data().name  +"</td><td>"+ element.data().DoS +"</td><td>"+"exam"+"</td><td>"+ element.data().status +"</td><td> "+ "pending"
               + "</td><td>"+"</td></tr>"  
                  
           }else if (element.data().lecture === true && element.data().approved === true) {
               
                    
               tb_div2.innerHTML += "<tr><th>"+ element.id  +"</th><td>"+ element.data().name  +"</td><td>"+ element.data().DoS +"</td><td>"+"lecture"+"</td><td>"+ element.data().status +"</td><td>"+"approved"
               +"</td><td>"+ "</td></tr>"  
                  
           }else if (element.data().lecture === true && element.data().rejected === true) {
              
                   
              tb_div2.innerHTML += "<tr><th>"+ element.id  +"</th><td>"+ element.data().name  +"</td><td>"+ element.data().DoS +"</td><td>"+"lecture"+"</td><td>"+ element.data().status +"</td><td> "+"rejected"
              +"</td><td>"+ "</td></tr>"  
                 
          }else if (element.data().lecture === true && element.data().rejected === false && element.data().approved === false ) {
              
                   
              tb_div2.innerHTML += "<tr><th>"+ element.id  +"</th><td>"+ element.data().name  +"</td><td>"+ element.data().DoS +"</td><td>"+"lecture"+"</td><td>"+ element.data().status +"</td><td> "+ "pending"
              + "</td><td>"+"</td></tr>"  
