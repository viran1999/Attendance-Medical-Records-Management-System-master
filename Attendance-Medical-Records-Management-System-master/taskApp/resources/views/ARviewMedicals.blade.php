    ...
    <body bgcolor="#4CAF50">
        ...
        <div class="row">
            <div class="col-md-2" style="margin:0px 0px 0px 0px ;  ">    
                <div class="sidenav">
                    <a class="btn btn-outline-light" href="#" style="border-bottom:6px solid #000" >Send To UMO</a>
      ...
      <div class="table-responsive">
          ...
          <table id="tableData" class="table"  style="background-color: #167F92 ;   margin:0px 80px 0px 0px;">
            ...
            <thead>
                ...
                <th scope="col" style="text-align: center">Send to UMO</th>
...
<script src="https://www.gstatic.com/firebasejs/7.21.0/firebase-firestore.js"></script>
            ...
            if (element.data().status === "AR"  && element.data().approved === false && element.data().rejected === false) {
               
                tb_div2.innerHTML += "<tr><th>"+ element.id  +"</th><td>"+ element.data().name  +"</td><td>"+ element.data().DoS 
                +"</td><td>"+"<input type = 'checkbox' id="+element.id+" >"  +"</td><td>"+ "</td></tr>"      
...
$("input:checkbox").each(function(){
    ...
    if($this.is(":checked")){
        ...
        db.collection("addmedical").doc($this.attr("id")).update({
...
<br><button type="button" class="btn btn-primary" onclick="UMO()">Send to UMO</button>
</body>  
</html>