    ...
    <body bgcolor="#4CAF50">
        ...
        <div class="row">
            <div class="col-md-2" style="margin:0px 0px 0px 0px ;  ">    
                <div class="sidenav">
                    <a class="btn btn-outline-light" href="/add" style="border-bottom:6px solid #000" >Add</a>
                    ...
                    <a class="btn btn-outline-light" href="#">View rejected</a>
...
<script src="https://www.gstatic.com/firebasejs/7.21.0/firebase-firestore.js"></script>
            ...
            query.forEach(element => {
             if (element.data().rejected === true && element.data().notify != "true" ) {
...
function notify(){
    db.collection('addmedical').onSnapshot(query => {
            query.forEach(element => {
            if (element.data().rejected === true) {
                db.collection("addmedical").doc(element.id).update({
...
<br><button type="button" class="btn btn-primary" onclick="notify()">Notify Students</button>
</body>  
</html>