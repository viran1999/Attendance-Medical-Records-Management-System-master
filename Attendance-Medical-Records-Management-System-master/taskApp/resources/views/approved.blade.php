        ...
        <div class="row">
            <div class="col-md-2" style="margin:0px 0px 0px 0px ;  ">    
                <div class="sidenav">
                    ...
                    <a class="btn btn-outline-light" href="#">Approved medicals for lectures</a>
                </div>
...
<script src="https://www.gstatic.com/firebasejs/7.21.0/firebase-firestore.js"></script>
            ...
            if (element.data().approved === true && element.data().status === "UMO" && element.data().lecture === true) {
...
<br><button type="button" class="btn btn-primary" onclick="mark()">Mark as Present</button>
</body>  
</html>